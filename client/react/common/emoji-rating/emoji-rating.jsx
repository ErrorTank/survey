...
export const EmojiRating = () => {
    useEffect(() => {
        ...
        return () => {
            document.querySelector(".rating-container").classList.remove("clip-marker");
    ...
    return (
        <div className="rating-container">
            <div className="rating-control">
                    ...
                    <div className="icon">
                        <svg width="100%" height="100%" viewBox="0 0 50 50">
                            ...
                            <path
                                ...
                                className="mouth" fill="#FFFFFF"></path>
                            <path
                                ...
                                className="right-eye" fill="#FFFFFF"></path>
                            <path
                                ...
                                className="left-eye" fill="#FFFFFF"></path>
                        </svg>
                    </div>
                    <div className="label">Terrible</div>
                    <div className="touch-marker"></div>
                </div>
                <div className="rating-option" rating="2" selected-fill="#FFC385">
                    <div className="icon">
                        <svg width="100%" height="100%" viewBox="0 0 50 50">
                            <path
                                d="M50,25 C50,38.807 38.807,50 25,50 C11.193,50 0,38.807 0,25 C0,11.193 11.193,0 25,0 C38.807,0 50,11.193 50,25"
                ...
                <div className="rating-option" rating="3">
                    <div className="icon">
                        <svg width="100%" height="100%" viewBox="0 0 50 50">
                            <path
                                d="M50,25 C50,38.807 38.807,50 25,50 C11.193,50 0,38.807 0,25 C0,11.193 11.193,0 25,0 C38.807,0 50,11.193 50,25"
                ...
                <div className="rating-option" rating="4">
                    <div className="icon">
                        <svg width="100%" height="100%" viewBox="0 0 50 50">
                            <path
                                d="M50,25 C50,38.807 38.807,50 25,50 C11.193,50 0,38.807 0,25 C0,11.193 11.193,0 25,0 C38.807,0 50,11.193 50,25"
                ...
                <div className="rating-option" rating="5">
                    <div className="icon">
                        <svg width="100%" height="100%" viewBox="0 0 50 50">
                            <path
                                d="M50,25 C50,38.807 38.807,50 25,50 C11.193,50 0,38.807 0,25 C0,11.193 11.193,0 25,0 C38.807,0 50,11.193 50,25"
